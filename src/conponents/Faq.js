      ...
      <div style={{ marginBottom: "50px" }}>
        <Container>
          <div style={{width: "80%", marginLeft: "10%"}}>
            <p style={{color: "#002b5b", fontWeight: "bold", fontSize: "18px"}}>【認識我們】</p>
            ...
            <br />
            <p style={{color: "#002b5b", fontWeight: "bold", fontSize: "18px"}}>【合作機構-註冊登入】</p>
            ...
            <br />
            <p style={{color: "#002b5b", fontWeight: "bold", fontSize: "18px"}}>【合作機構-物資領取】</p>
            <Accordion alwaysOpen>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <span style={{ letterSpacing: "1.5px" }}>
            ...
            <br />
            <p style={{color: "#002b5b", fontWeight: "bold", fontSize: "18px"}}>【捐贈者-註冊】</p>
            <Accordion alwaysOpen>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <span style={{ letterSpacing: "1.5px" }}>
            ...
            <br />
            <p style={{color: "#002b5b", fontWeight: "bold", fontSize: "18px"}}>【捐贈者-物資認購】</p>
            <Accordion alwaysOpen>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <span style={{ letterSpacing: "1.5px" }}>
            ...
            <br />
            <p style={{color: "#002b5b", fontWeight: "bold", fontSize: "18px"}}>【捐贈者-機構】</p>
            <Accordion alwaysOpen>
              <Accordion.Item eventKey="0">
                <Accordion.Header>
                  <span style={{ letterSpacing: "1.5px" }}>
